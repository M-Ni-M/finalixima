  ...
  return (
    <> <section className="h-screen w-full flex flex-col md:flex-row">
            ...
            <div className="flex flex-col justify-center items-center w-full mt-20 md:w-2/3 bg-white p-4 md:p-8 lg:p-16">
              <h1 className="font-[MuseoModerno] text-4xl sm:text-5xl md:text-4xl lg:text-7xl font-bold text-center whitespace-nowrap">
Signup to start bidding              </h1>
              <form
                action=""
              ...
              >
                ...
                <p className="text-lg md:text-xl lg:text-2xl my-3">or signup with</p>
                <button
                  type="button"
